...
def response(flow):
    ...
    # https://aweme.snssdk.com/aweme/v2/comment/list/?aweme_id=6950849003122593062&cursor=20&count=20&insert_ids&address_book_access=1&gps_access=1&forward_page_type=1&channel_id=0&city=131100&hotsoon_filtered_count=0&hotsoon_has_more=0&follower_count=0&is_familiar=0&page_source=0&user_avatar_shrink=64_64&aweme_author=MS4wLjABAAAAlNYN1nprfzhKi1E83nGK7zrMhWaZ5OIijDU7CrKN704&item_type=0&os_api=22&device_type=MI+9&ssmix=a&manifest_version_code=150201&dpi=240&uuid=863254448523315&app_name=aweme&version_name=15.2.0&ts=1619091440&cpu_support64=false&app_type=normal&appTheme=dark&ac=wifi&host_abi=armeabi-v7a&update_version_code=15209900&channel=aweGW&_rticket=1619091440759&device_platform=android&iid=1055978136805502&version_code=150200&cdid=27bf111e-7f8f-4124-ae58-3302bd05bfe2&openudid=827c2edcf09beb7f&device_id=932811710418807&resolution=720*1280&os_version=5.1.1&language=zh&device_brand=Xiaomi&aid=1128&minor_status=0&mcc_mnc=46007
    if 'aweme.snssdk.com/aweme/v2/comment/list/' in flow.request.url:
        ...
        for data in json.loads(flow.response.text)['comments']:
            ...
            # time_local = time.localtime(int(Time))  # 注意：这里的整数不能超过11位数
